...
export const CONTACT_NO = '+91 88497 82332';
export const CONTACT_MAIL = 'techsamrajyaofficial@gmail.com';
export const HR_MAIL = 'hr.techsamrajya@gmail.com';
export const ADDRESS = 'Shop 50, regent plaza, Dindoli, Surat, Gujarat 394210';
export const LOCATION = 'https://www.google.com/maps/@21.1592002,72.8222963,12z';
...
export const TECHNOLOGIES_DATA = [
    {
      ...
      title: "Frontend",
      content: [
        { link: "/technology#reactjs", title: "ReactJS" },
        { link: "/technology#nextjs", title: "NextJS" },
        { link: "/technology#angularjs", title: "AngularJS" },
      ],
    },
    {
      link: "",
