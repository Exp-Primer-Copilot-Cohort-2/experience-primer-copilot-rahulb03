                        ...
                        <div className="col-lg-8 col-md-12">
                           <div className="tp-fun-fact-content h-100 d-flex flex-column align-items-center justify-content-center">
                              <div className="tp-fun-fact-title-wrapper">
                                 ...
                                 <p>Embracing the belief that tech can change the world, our company leads the charge by providing innovative solutions that harness the power of technology to transform industries, streamline processes, and drive positive global impact.</p>
                                 <ul className='d-none'>
                                    <li>
